...
[
  ...
  # "\"type.enum\" = \( | v)",
  # "\"type.enum.variant\" = \( | v)",
  "\"constructor\" = \(.syntax.type | style | v)",
  ...
  "\"variable.builtin\" = \(.syntax."variable.special" | style | v)",
  ...
  "[palette]",
  "\"default\" = \(.text | rgb | v)",
  "\"black\" = \(."terminal.ansi.bright_black" | rgb | v)",
  "\"red\" = \(."terminal.ansi.bright_red" | rgb | v)",
  "\"green\" = \(."terminal.ansi.bright_green" | rgb | v)",
  "\"yellow\" = \(."terminal.ansi.bright_yellow" | rgb | v)",
  "\"blue\" = \(."terminal.ansi.bright_blue" | rgb | v)",
  "\"magenta\" = \(."terminal.ansi.bright_magenta" | rgb | v)",
  "\"cyan\" = \(."terminal.ansi.bright_cyan" | rgb | v)",
  "\"gray\" = \(."terminal.ansi.bright_white" | rgb | v)",
