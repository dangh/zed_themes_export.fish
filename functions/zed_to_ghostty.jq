...
$s |
[
  "palette = 0=\(."terminal.ansi.bright_black" | blend_bg)",
  "palette = 1=\(."terminal.ansi.bright_red" | blend_bg)",
  "palette = 2=\(."terminal.ansi.bright_green" | blend_bg)",
  "palette = 3=\(."terminal.ansi.bright_yellow" | blend_bg)",
  "palette = 4=\(."terminal.ansi.bright_blue" | blend_bg)",
  "palette = 5=\(."terminal.ansi.bright_magenta" | blend_bg)",
  "palette = 6=\(."terminal.ansi.bright_cyan" | blend_bg)",
  "palette = 7=\(."terminal.ansi.bright_white" | blend_bg)",
  ...
  "cursor-text = \(."terminal.bright_foreground" | blend_bg)",
  "selection-background = \(.players[0].selection | blend_bg)",
  "selection-foreground = \(."terminal.bright_foreground" | blend_bg)",
